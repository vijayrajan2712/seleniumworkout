// Volume profile / Point of Control (POC): buckets traded volume by price over the
// current session and finds the price level with the highest traded volume.

const DEFAULT_LOOKBACK = 75; // ~1 NSE cash session at 5m candles
const BUCKETS = 30;
